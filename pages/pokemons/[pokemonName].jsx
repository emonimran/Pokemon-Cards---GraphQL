            ...
            <div className="sm:order-2 sm:w-1/3 flex items-center justify-center">
              <div className="">
                <img
                  ...
                  width={300}
                  height={300}
                  className="rounded-lg hover:scale-125 transition duration-500"
                />
                {!isMediumScreen ? (
                  <div className="w-full flex items-center justify-center">
                    <Link href="/">
                      <button className="bg-yellow flex text-white border-4 border-blue py-4 px-8 sm:mt-36 font-semibold">
                        <svg
